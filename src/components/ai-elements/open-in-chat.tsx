...
import { ArrowDown01Icon, LinkSquare02Icon, BubbleChatIcon } from "@hugeicons/core-free-icons";
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      ...
      >
        ...
        <HugeiconsIcon icon={LinkSquare02Icon} strokeWidth={2} className="size-4 shrink-0" />
      </a>
    </DropdownMenuItem>
  );
};
